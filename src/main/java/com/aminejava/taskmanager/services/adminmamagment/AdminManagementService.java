...
public class AdminManagementService {
    ...
    public AdminManagementService(AdminAuthService adminAuthService, ProjectService projectService, UserService userService,
                                  AdminRepository adminRepository, TaskService taskService, SubTaskService subTaskService, SystemTaskManager systemTaskManager, ProjectConverter projectConverter, JwtGenerator jwtGenerator,
                                  PermissionRepository permissionRepository, UserAuthService userAuthService) {
